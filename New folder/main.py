...
img = Image.open(r"C:\Users\user\Documents\Website\New folder\seemandham.jpg")
img_re=img.resize((400,600))

img1 = Image.open(r"C:\Users\user\Documents\Website\New folder\foots.jpg")
img_re1=img1.resize((400,100))

img2 = Image.open(r"C:\Users\user\Documents\Website\New folder\baby.jpeg")
